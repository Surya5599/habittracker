...
export const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({ onOpenFeedback }) => {
    ...
    return (
        <div className="min-h-screen bg-canvas p-2 sm:p-4 font-sans text-[#444]">
            <div className="max-w-4xl mx-auto bg-surface border-2 sm:border-3 border-edge-strong shadow-neo sm:shadow-neo-lg p-6 sm:p-8 min-h-[calc(100vh-2rem)]">
                ...
                <div className="mb-8 flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-xs font-black uppercase tracking-widest text-ink-subtle">HabiCard</p>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-surface-muted p-6 rounded-xl border border-edge">
                        <p className="text-xs font-black uppercase tracking-widest text-ink-subtle mb-1">Last Updated</p>
                        <p className="font-bold text-sm">August 5, 2026</p>
                    ...
                    <section>
                        <div className="flex items-center gap-2 mb-3">
                            <Eye className="w-5 h-5 text-ink-strong flex-shrink-0" />
                        ...
                        <div className="space-y-4 text-sm text-ink leading-relaxed">
                            <div>
                                <p className="font-bold text-ink-strong mb-1">Account Information</p>
                            ...
                            <div>
                                <p className="font-bold text-ink-strong mb-1">Habit & Usage Data</p>
                            ...
                            <div>
                                <p className="font-bold text-ink-strong mb-1">AI Coach Chats</p>
                                <p>If you use the AI Coach feature, we store your daily insight, chosen coach personality, and the full text of any messages you send in that conversation, associated with your account. This history is used to generate future insights and is deleted along with your account.</p>
                            </div>
                            <div>
                                <p className="font-bold text-ink-strong mb-1">Guest Mode</p>
                            ...
                            <div>
                                <p className="font-bold text-ink-strong mb-1">Feedback & Support</p>
                            ...
                            <div>
                                <p className="font-bold text-ink-strong mb-1">What We Do Not Collect</p>
                    ...
                    <section>
                        <div className="flex items-center gap-2 mb-3">
                            <Server className="w-5 h-5 text-ink-strong flex-shrink-0" />
                            <h2 className="text-lg font-black uppercase tracking-tight">2. How We Store Your Data</h2>
                        </div>
                        <div className="space-y-4 text-sm text-ink leading-relaxed">
                            <div>
                                <p className="font-bold text-ink-strong mb-1">Database</p>
                            ...
                            <div>
                                <p className="font-bold text-ink-strong mb-1">Encryption</p>
                            ...
                            <div>
                                <p className="font-bold text-ink-strong mb-1">Retention</p>
                                <p>Your data is retained for as long as your account is active. If you delete your account, all associated records (habits, completions, journal entries, notes, goals, AI Coach chat history, feedback) are permanently deleted from our database within 30 days.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        <div className="flex items-center gap-2 mb-3">
                            <Globe className="w-5 h-5 text-ink-strong flex-shrink-0" />
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-xs border border-edge rounded-lg overflow-hidden">
                                    <thead className="bg-surface-strong">
                                        <tr>
                                            <th className="text-left p-3 font-black uppercase tracking-wide text-ink">Service</th>
                                            <th className="text-left p-3 font-black uppercase tracking-wide text-ink">Purpose</th>
                                            <th className="text-left p-3 font-black uppercase tracking-wide text-ink">Data Shared</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-edge-subtle">
                                        ...
                                        <tr>
                                            ...
                                            <td className="p-3">Optional AI Coach insights & chat</td>
                                            <td className="p-3">Habit names, descriptions, and completion stats; the text of any messages you send the AI Coach. Sent per-request via our server, not stored by Google.</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <section>
                        <div className="flex items-center gap-2 mb-3">
                            <Shield className="w-5 h-5 text-ink-strong flex-shrink-0" />
                        ...
                        <div className="space-y-3 text-sm text-ink leading-relaxed">
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                <li><strong className="text-ink-strong">storage</strong> — to save your session and preferences locally in the browser</li>
                                <li><strong className="text-ink-strong">tabs</strong> — to open habicard.com in a new tab when you click "Open full app"</li>
                            </ul>
                    ...
                    <section>
                        <div className="flex items-center gap-2 mb-3">
                            <Lock className="w-5 h-5 text-ink-strong flex-shrink-0" />
                            <h2 className="text-lg font-black uppercase tracking-tight">5. Your Rights</h2>
                        </div>
                        <div className="space-y-3 text-sm text-ink leading-relaxed">
                            <p>You have the following rights regarding your personal data:</p>
                            <ul className="list-disc pl-5 space-y-2">
                                <li><strong className="text-ink-strong">Access:</strong> You can view all data stored in your account within the app.</li>
                                <li><strong className="text-ink-strong">Correction:</strong> You can edit your habit names, journal entries, and other content at any time.</li>
                                <li><strong className="text-ink-strong">Deletion:</strong> You can delete individual records at any time. To delete your entire account and all data, go to Settings → Delete Account, or contact us.</li>
                                <li><strong className="text-ink-strong">Portability:</strong> You can export your journal entries from within the app at any time.</li>
                                <li><strong className="text-ink-strong">Opt out:</strong> You can use HabiCard in guest mode without creating an account, keeping all data on your device only.</li>
                            </ul>
                    ...
                    <section>
                        <div className="flex items-center gap-2 mb-3">
                            <Trash2 className="w-5 h-5 text-ink-strong flex-shrink-0" />
                        ...
                        <div className="space-y-3 text-sm text-ink leading-relaxed">
                            ...
                            <ol className="list-decimal pl-5 space-y-1">
                                ...
                                <li>Scroll to the bottom and tap <strong className="text-ink-strong">Delete Account</strong></li>
                            </ol>
                            <p>Alternatively, email us at <a href="mailto:support@habicard.com" className="font-bold underline text-ink-strong">support@habicard.com</a> with the subject "Delete my account" and we will process your request within 30 days.</p>
                        </div>
                    </section>
                    ...
                    <section>
                        <div className="flex items-center gap-2 mb-3">
                            <Mail className="w-5 h-5 text-ink-strong flex-shrink-0" />
                        ...
                        <div className="space-y-3 text-sm text-ink leading-relaxed">
                            ...
                            <div className="bg-surface-muted border border-edge rounded-xl p-4">
                                <p className="font-black text-ink-strong">HabiCard</p>
                                <p>Email: <a href="mailto:support@habicard.com" className="font-bold underline text-ink-strong">support@habicard.com</a></p>
                                <p>Website: <a href="https://habicard.com" className="font-bold underline text-ink-strong">habicard.com</a></p>
                            </div>
                            <div className="mt-4">
                                <button
                                    onClick={onOpenFeedback}
                                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-surface-inverse text-ink-inverse text-sm font-bold uppercase tracking-widest rounded-lg hover:opacity-80 transition-opacity"
                                >
                ...
                {/* Footer nav */}
                <div className="mt-10 pt-6 border-t-2 border-edge-strong flex items-center justify-between">
                    <button
                        onClick={() => navigate('/')}
                    ...
                    <span className="text-xs text-ink-subtle font-bold uppercase tracking-widest">© 2026 HabiCard</span>
                </div>
