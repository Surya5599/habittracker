...
import { CheckCircle, Reply, Loader2, RefreshCw } from 'lucide-react';
...
export const TicketList: React.FC<TicketListProps> = () => {
    ...
    useEffect(() => {
        ...
        // Keep inbox fresh without full reload.
        const intervalId = window.setInterval(fetchTickets, 30000);

        const channel = supabase
            .channel('admin-inbox-live')
            .on('postgres_changes', { event: '*', schema: 'public', table: 'feedback' }, () => fetchTickets())
            .subscribe();
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="px-3 py-2 bg-white text-stone-500 hover:bg-stone-50 neo-border transition-all"
                        title="Refresh inbox"
