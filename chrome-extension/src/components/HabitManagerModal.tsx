        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white border-[2px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] w-full max-w-md overflow-hidden flex flex-col max-h-[80vh] animate-in zoom-in-95 duration-200">
                <div className="p-4 border-b-[2px] border-black flex items-center justify-between bg-white">
                    <h2 className="text-2xl font-black uppercase tracking-tighter text-black">My Habits</h2>
                ...
                <div ref={listRef} className="flex-1 overflow-y-auto p-4 space-y-2">
                    ...
                    {habits.map(habit => (
                        <div key={habit.id} className="group flex items-start justify-between p-3 bg-white border-[2px] border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none transition-all mb-3">
                            <div className="flex items-start gap-3 flex-1 min-w-0 pr-2">
                                <div className="w-4 h-4 rounded-full shrink-0 border-2 border-black mt-0.5" style={{ backgroundColor: habit.color || themePrimary }}></div>
                                ...
                                {editingId === habit.id ? (
                                    ...
                                    <span
                                        ...
                                        className="flex-1 text-sm font-bold text-black break-words cursor-pointer hover:underline decoration-2 underline-offset-2"
                                    >
                            ...
                            <div className="flex items-start gap-1 ml-2 shrink-0">
                                <button
                                    ...
                                    title={editingId === habit.id ? "Save" : "Edit Name"}
                                >
