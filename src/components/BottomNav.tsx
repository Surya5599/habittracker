...
export const BottomNav: React.FC<BottomNavProps> = ({ view, setView, resetWeekOffset, theme }) => {
    ...
    return (
        <div className="md:hidden fixed bottom-0 left-0 right-0 bg-surface border-t-3 border-edge-strong shadow-[0_-6px_0px_0px_rgba(0,0,0,1)] flex justify-around items-center z-50" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
